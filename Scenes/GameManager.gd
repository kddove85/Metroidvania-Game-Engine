...
func load_menu():
	var menu = load("res://Scenes/UI/MainMenu.tscn").instance()
...
func get_area(area):
	return load("res://Scenes/Areas/%s.tscn" % area).instance()
...
func on_open_bonfire_menu(bonfire_name):
	...
	var bonfire_menu = load("res://Scenes/UI/BonfireMenu.tscn").instance()
...
func on_open_dialogue(dialogue):
	var dialogue_box = load("res://Scenes/UI/DialogueBox.tscn").instance()
